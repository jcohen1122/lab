...
class TransparentShape<T extends Shape> implements Shape
{
    ...
    {
        shape = ctor.get(); // calls the constructor to get the object
...
class StaticDecoratorDemo {
    public static void main(String[] args) {
        ...
        ColoredShape<Square> blueSquare = new ColoredShape<>(() -> new Square(20), "blue"); // Supplier is lambda function providing the object
